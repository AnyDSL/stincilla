  ...
  while(_count != _imSIZE+_DELAY){
    {
      ...
      #pragma ivdep
      {
        ...
        float _newPixel_input_img_0 = _rows_input_img[0*imWIDTH + _cols];
        float _newPixel_input_img_1 = _rows_input_img[1*imWIDTH + _cols];
        float _newPixel_input_img_2 = _rows_input_img[2*imWIDTH + _cols];
        float _newPixel_input_img_3 = _rows_input_img[3*imWIDTH + _cols];
        // Shift Raw Buffer
        _rows_input_img[0*imWIDTH + _cols] = _newPixel_input_img_1;
        _rows_input_img[1*imWIDTH + _cols] = _newPixel_input_img_2;
        _rows_input_img[2*imWIDTH + _cols] = _newPixel_input_img_3;
        _rows_input_img[3*imWIDTH + _cols] = _newPixel_input_img_4;
