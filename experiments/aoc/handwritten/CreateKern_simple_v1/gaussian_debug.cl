  ...
  while(_count != _imSIZE+_DELAY){
    {
      ...
      #pragma ivdep
      {
        ...
        float _newPixel_input_img_0 = _rows_input_img_0[imWIDTH-1];
        float _newPixel_input_img_1 = _rows_input_img_1[imWIDTH-1];
        float _newPixel_input_img_2 = _rows_input_img_2[imWIDTH-1];
        float _newPixel_input_img_3 = _rows_input_img_3[imWIDTH-1];
        // Shift Raw Buffer
        for(int _i = imWIDTH-1; _i > 0; _i--){
            _rows_input_img_0[_i] = _rows_input_img_0[_i - 1];
            _rows_input_img_1[_i] = _rows_input_img_1[_i - 1];
            _rows_input_img_2[_i] = _rows_input_img_2[_i - 1];
            _rows_input_img_3[_i] = _rows_input_img_3[_i - 1];
        }
        _rows_input_img_0[0] = _newPixel_input_img_1;
        _rows_input_img_1[0] = _newPixel_input_img_2;
        _rows_input_img_2[0] = _newPixel_input_img_3;
        _rows_input_img_3[0] = _newPixel_input_img_4;
